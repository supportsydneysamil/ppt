...
import { appendExtraTitleSlide } from "./title-slide-extra.js";
import {
  defaultTitleEn,
  defaultTitleKo,
...
export function appendTitleSlideWithExtraRenderer(
  pptx,
  slide,
  extraRenderer = appendExtraTitleSlide
) {
  ...
  if (!extraRenderer(pptx, design, content)) {
    addChapelSlide(pptx, content);
  }
}
...
export function appendTitleSlide(pptx, slide) {
  appendTitleSlideWithExtraRenderer(pptx, slide);
}
