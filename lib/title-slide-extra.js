// Seasonal PPTX renderers for Sunday worship title slides.
...
function addEasterStainedSlide(pptx, content) {
  ...
  addText(slide, content.en, {
    ...
    h: 0.42,
    fontFace: LATIN,
    fontSize: worshipEnFontSize(content.en, 17, 4.93),
    bold: true,
    color: "E4D4FF",
    align: "center",
    charSpacing: 7,
...
/** Adds a seasonal design, returning false for the original designs. */
