...
export function deriveSaveButtonState({
  ...
  const busy = isSaveBusy({ slideSaving, templateSaving, reorderSaving });
...
export function isSaveBusy({ slideSaving, templateSaving, reorderSaving }) {
  return Boolean(slideSaving || templateSaving || reorderSaving);
}
