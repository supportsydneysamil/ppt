...
const DESIGNS_BY_CATEGORY = {
  ...
  christmas: [
    {
      ...
      layoutFamily: "centered-rule",
      asset: {
        path: "assets/custom-title/bethlehem.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  easter: [
    ...
    },
    {
      ...
      asset: {
        path: "assets/custom-title/empty-tomb.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  lent: [
    ...
    },
    {
      ...
      asset: {
        path: "assets/custom-title/wilderness.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  "palm-sunday": [
    {
      ...
      layoutFamily: "corner-mark",
      asset: {
        path: "assets/custom-title/palm-shadow.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  "barley-harvest": [
    {
      ...
      layoutFamily: "ornament-frame",
      asset: {
        path: "assets/custom-title/first-fruits.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  "year-end": [
    {
      ...
      layoutFamily: "veil-panel",
      asset: {
        path: "assets/custom-title/midnight-gate.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  "new-year": [
    ...
    },
    {
      ...
      layoutFamily: "side-band",
      asset: {
        path: "assets/custom-title/new-path.png",
        width: 1280,
        height: 720,
      },
      theme: {
  ...
  premium: [
    ...
    },
    {
      ...
      layoutFamily: "veil-panel",
      asset: {
        path: "assets/custom-title/cobalt-ripple.png",
        width: 1280,
        height: 720,
      },
      theme: {
